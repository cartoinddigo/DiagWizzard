...
class Multimode: # Définition de la classe OD
    ...
    def navjourney(self, timenavitia, distmax, s_id, s_olat, s_olng, s_dlat, s_dlng, token):
        ...
        self.urlccc = '&first_section_mode[]=walking&first_section_mode[]=bike&first_section_mode[]=bss'
        ...
        self.urlq = self.urla+self.urlaa+self.coverage+self.urlaaa+self.s_norigine+self.urlb+self.s_ndestination+self.urlc+self.urlcc+self.urlaaaa+self.timenavitia+self.urlccc
        ...
        with open(self.fichiersal) as f:
            ...
            with open(self.resultfichier, 'w')as sortie:
                ...
                for row in reader:
                    ...
                    result = s_id,s_olat,s_olng,s_dlat,s_dlng,nduration,ncorres,ntype
                    resultmessage_idtra = str(s_id)
                    ...
                    csv_out.writerow((s_id,s_olat,s_olng,s_dlat,s_dlng,nduration,ncorres,ntype))
