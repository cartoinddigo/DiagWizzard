...
pathuser = "c:/CartoInddigo/DiagWizzard/Scripts/Direction/"
fsource = QFileDialog.getOpenFileName(None, "Selectionner le fichier source", pathuser)
...
with open(fsource) as csvfile:
    ...
    for row in sources:
        ...
        legs.append(directions_result[0]["legs"])
        ...
        for l in legs:
            ...
            for s in steps:
                pt = s[0]["polyline"]["points"]
        print(pt)
#                
#                for p in pt:
#                    ppt = p[0]["polyline"]["points"]
#                    coord_chunks = [[]]
#                    for char in ppt:
#                        value = ord(char) - 63
