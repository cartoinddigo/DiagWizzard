...
<qgis version="2.18.1" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/fontFamily" value="Tw Cen MT"/>
    <property key="labeling/fontItalic" value="true"/>
    <property key="labeling/fontLetterSpacing" value="0.984375"/>
    ...
    <property key="labeling/textColorG" value="89"/>
  ...
  <displayfield>LARGEUR</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    <alias field="LARGEUR" index="0" name=""/>
    <alias field="TOPONYME" index="1" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;LARGEUR&quot;" sortOrder="0">
    <columns>
